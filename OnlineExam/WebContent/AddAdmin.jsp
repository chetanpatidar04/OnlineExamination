...
<body>
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form" action ="AddAdmin" method="Post">
	...
	<div class="wrap-input100 validate-input">
    	<span class="label-input100">SecurityQue:</span>
			 <select name="security">
    			<option value="What is your first bike number?">What is your first bike number?</option>
    			<option value="What is favourite movie?">what is favourite movie?</option>
    			<option value="Which is your  favourite faction brand?">Which is your  favourite faction brand?</option>
    			<option value="Which place you like most?">Which place you like most?</option>
        ...
        <span class="focus-input100"></span>			
				...
				<div class="wrap-input100 validate-input" data-validate="Answer is required">
					...
					<input class="input100" type="text" name="answer" placeholder="Select username for Login">
					<span class="focus-input100"></span>
				</div>
